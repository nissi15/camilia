...
import { PackageOpen, Scissors, ClipboardList, Package, BarChart3, PlusCircle, MessageSquare, Send } from "lucide-react";
...
const restaurantActions: QuickAction[] = [
  { label: "New Request", href: "/tg/new-request", icon: PlusCircle, color: "bg-emerald-500", desc: "Order ingredients" },
  { label: "My Requests", href: "/tg/requests", icon: Send, color: "bg-amber-500", desc: "Track your orders" },
  { label: "Messages", href: "/tg/messages", icon: MessageSquare, color: "bg-blue-500", desc: "Chat with warehouse" },
  { label: "Stock Check", href: "/tg/stock", icon: Package, color: "bg-purple-500", desc: "Current inventory levels" },
  { label: "Quick Report", href: "/tg/report", icon: BarChart3, color: "bg-rose-500", desc: "Today's summary" },
];
